...
@Component({
  selector: 'dados-cadastro-canal-vendas',
  templateUrl: './dados-cadastro-canal-vendas.component.html',
  styleUrls: ['./dados-cadastro-canal-vendas.scss'],
})
export class DadosCadastroCanalVendasComponent implements OnInit, OnDestroy {
  ...
  constructor(private options: CanalVendasComponent,
  ...
  salvarDados() {
    if (this.formulario.value.nome === null || this.formulario.value.nome.trim() === '') {
      ...
      this.erro = false;
      this.mensagem_erro = '';
      this.options.insereCanalVendas(this.formulario.value);
    }
  }
  ...
  editarDados() {
    if (this.formulario.value.nome === null || this.formulario.value.nome.trim() === '') {
      ...
      this.erro = false;
      this.mensagem_erro = '';
      this.options.alteraCanalVendas(this.formulario.value);
      this.modalConfirmacao.close();
    }
  }
  ...
  excluirDados() {
    if (this.formulario.value.pk === null || this.formulario.value.pk === '') {
      ...
      this.erro = false;
      this.mensagem_erro = '';
      this.options.excluirCanalVendas(this.formulario.value);
      this.modalConfirmacao.close();
    }
  }
